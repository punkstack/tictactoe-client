...
void UI::AddAudioToggle( const std::string &onButton, const std::string &onButtonPressed, const std::string &offButton, const std::string &offButtonPressed, cocos2d::Scene *layer, int position )
{
...
void UI::AddCentredBackground( const std::string &background, cocos2d::Scene *layer )
{
